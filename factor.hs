...
factor fileName = do
                     ...
                     putStr "\n"
                     putStrLn ( "SOURCE = " ++ format source )
                     putStrLn ( "RESULT = " ++ eval ( builtIn ++ source) )
...
--------------------------------------------------------------------------------
--                             Assignment #4                                  --
-- 1. I rewrite "factor" and "format" function.                               --
-- swap:exchange the top two stack items  : 4 7 swap => 7 4                   --
-- the output of swap should not be 7 4 , cause stack is first in last out    --
-- it should output 4 7                                                       --
--------------------------------------------------------------------------------
builtIn :: String
builtIn = unlines [
        ": swap 2 lift ;",
